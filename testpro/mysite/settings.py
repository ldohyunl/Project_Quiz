...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'),  # 프로젝트 templates 폴더
            os.path.join(BASE_DIR, 'history', 'templates'),  # history 앱 templates 폴더 추가
            os.path.join(BASE_DIR, 'quiz_app', 'templates'),  # quiz_app 앱 templates 폴더 추가
            os.path.join(BASE_DIR, 'accounts', 'templates'),  # accounts 앱 templates 폴더 추가
        ],
